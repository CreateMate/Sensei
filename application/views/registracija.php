<body>
    <h1 class="wrap-out registracija">Make your Sensei account</h1>
	<div class="login-form">
		<h1 class="wrap-in">Register</h1>
                <h3><?php validation_errors();?></h3>
		<?php print form_open('Registracija',$form_tag_atributi); ?>
      ...
      <div class="form-group log-status-pass">
        ...
        <?php endif; ?>
		 ...
		 <input type="submit" name="btnRegistracija" id="btnRegistracija" class="log-btn" value="Next Step"><br/><br/>
